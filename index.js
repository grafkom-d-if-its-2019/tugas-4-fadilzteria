(function() {
  ...
  var verticeTriangle = new Float32Array([
    //x,y,z           //r,g,b
      // Left
      +0.15, -0.5, 0.0, 1.0, 1.0, 0.0,
      +0.15, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.3167, -0.5, 0.0, 0.0, 1.0, 1.0,

      +0.15, -0.4, 0.0, 1.0, 1.0, 0.0,
      +0.3167, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.3167, -0.5, 0.0, 0.0, 1.0, 1.0,

      +0.2, -0.4, 0.0, 1.0, 1.0, 0.0,
      +0.2, +0.3, 0.0, 1.0, 0.0, 1.0,
      +0.2667, -0.4, 0.0, 0.0, 1.0, 1.0,

      +0.2, +0.3, 0.0, 1.0, 1.0, 0.0,
      +0.2667, +0.3, 0.0, 1.0, 0.0, 1.0,
      +0.2667, -0.4, 0.0, 0.0, 1.0, 1.0, 

      +0.2, +0.3, 0.0,1.0, 1.0, 0.0,
      +0.2667, +0.3, 0.0, 1.0, 0.0, 1.0,
      +0.2, +0.5, 0.0, 0.0, 1.0, 1.0,

      +0.2, +0.5, 0.0, 1.0, 1.0, 0.0,
      +0.2667, +0.3, 0.0, 1.0, 0.0, 1.0,
      +0.3, +0.5, 0.0, 0.0, 1.0, 1.0,

      +0.15, +0.4, 0.0, 1.0, 1.0, 0.0,
      +0.15, +0.5, 0.0, 1.0, 0.0, 1.0,
      +0.2, +0.4, 0.0, 0.0, 1.0, 1.0,

      +0.15, +0.5, 0.0, 1.0, 1.0, 0.0,
      +0.2, +0.5, 0.0, 1.0, 0.0, 1.0,
      +0.2, +0.4, 0.0, 0.0, 1.0, 1.0,

      // Center
      +0.3, +0.5, 0.0, 1.0, 1.0, 0.0,
      +0.375, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.2667, +0.3, 0.0, 0.0, 1.0, 1.0,

      +0.3, +0.5, 0.0, 1.0, 1.0, 0.0,
      +0.375, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.4, -0.2, 0.0, 0.0, 1.0, 1.0,

      +0.4, -0.2, 0.0, 1.0, 1.0, 0.0,
      +0.375, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.425, -0.4, 0.0, 0.0, 1.0, 1.0,
      ...
      +0.425, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.5333, +0.3, 0.0, 0.0, 1.0, 1.0,

      // Right
      +0.5333, +0.3, 0.0, 1.0, 1.0, 0.0,
      +0.5, +0.5, 0.0, 1.0, 0.0, 1.0,
      +0.6, +0.5, 0.0, 0.0, 1.0, 1.0,

      +0.6, +0.5, 0.0, 1.0, 1.0, 0.0,
      +0.6, +0.3, 0.0, 1.0, 0.0, 1.0,
      +0.5333, +0.3, 0.0, 0.0, 1.0, 1.0,

      +0.6, +0.5, 0.0, 1.0, 1.0, 0.0,
      +0.65, +0.5, 0.0, 1.0, 0.0, 1.0,
      +0.6, +0.4, 0.0, 0.0, 1.0, 1.0,
      
      +0.65, +0.5, 0.0, 1.0, 1.0, 0.0,
      +0.6, +0.4, 0.0, 1.0, 0.0, 1.0,
      +0.65, +0.4, 0.0, 0.0, 1.0, 1.0,

      +0.5333, +0.3, 0.0, 1.0, 1.0, 0.0,
      +0.6, +0.3, 0.0, 1.0, 0.0, 1.0,
      +0.5333, -0.4, 0.0, 0.0, 1.0, 1.0,

      +0.6, +0.3, 0.0, 1.0, 1.0, 0.0,
      +0.5333, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.6, -0.4, 0.0, 0.0, 1.0, 1.0,

      +0.4833, -0.4, 0.0, 1.0, 1.0, 0.0,
      +0.65, -0.4, 0.0, 1.0, 0.0, 1.0,
      +0.4833, -0.5, 0.0, 0.0, 1.0, 1.0,

      +0.65, -0.4, 0.0, 1.0, 1.0, 0.0,
      +0.4833, -0.5, 0.0, 1.0, 0.0, 1.0,
      +0.65, -0.5, 0.0, 0.0, 1.0, 1.0
  ]);
  ...
  function draw(){
    ...
    ac = glMatrix.vec3.fromValues(0.17, 0.41, 0.02);
